...
for run in range(num_runs):
    ...
    acc_svm_no_abc.append(acc_no_abc)
    ...
    acc_svm_abc.append(best_accuracy)
...
# Final Results
# -------------------------------
avg_no_abc = np.mean(acc_svm_no_abc)
avg_with_abc = np.mean(acc_svm_abc)

total_selected_features = int(np.sum(final_best_solution))

print("Final Results:")
print("SVM without ABC Accuracy:", round(avg_no_abc, 4))
print("SVM with ABC Accuracy   :", round(avg_with_abc, 4))
